...
import 'package:bazar_marketplace_app/screens/orders/utils/index.dart';
import 'package:bazar_marketplace_app/utils/prefetching_helper.dart';
              ...
              Row(
                ...
                children: [
                  ...
                  MaterialButton(
                      ...
                      minWidth: MediaQuery.of(context).size.width / 2.2,
                      color: Theme.of(context).colorScheme.onBackground,
                      textColor: BazarTheme.primaryColor,
                      onPressed: () {
                        page = 1;

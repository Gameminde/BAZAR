import 'package:bazar_marketplace_app/screens/checkout/utils/index.dart';
import 'package:bazar_marketplace_app/screens/gdpr/bloc/gdpr_bloc.dart';
import 'package:bazar_marketplace_app/screens/gdpr/bloc/gdpr_state.dart';
import 'package:bazar_marketplace_app/screens/gdpr/view/widget/create_request.dart';
import 'package:bazar_marketplace_app/screens/home_page/data_model/theme_customization.dart';
import 'package:bazar_marketplace_app/screens/product_screen/view/file_download.dart';
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: BazarTheme.linkColor,
                        ...
                        child: Text(StringConstants.createRequest.localized(),
                            style: TextStyle(color: BazarTheme.primaryColor)),
                      ),
                    ],
                  ),
                  SizedBox(height: 20),
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: req['status']
                                                    ...
                                                    .toUpperCase() ==
                                                "REVOKED"
                                            ? BazarTheme.greyColor
                                            : BazarTheme.linkColor,
                                        shape: RoundedRectangleBorder(
                                          borderRadius:
  ...
  Widget _exportButton(String label) {
    return OutlinedButton(
      ...
      style: OutlinedButton.styleFrom(
        side: BorderSide(color: BazarTheme.skeletonLoaderColorLight),

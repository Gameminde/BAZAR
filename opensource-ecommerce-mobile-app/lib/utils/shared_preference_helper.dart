...
import 'package:bazar_marketplace_app/utils/server_configuration.dart';
import 'package:bazar_marketplace_app/utils/shared_preference_keys.dart';
import 'package:bazar_marketplace_app/utils/string_constants.dart';
...
class SharedPreferenceHelper {
  ...
  onUserLogout() {
    ...
    configurationStorage.write(customerRefreshToken, '0');
  ...
  setRefreshToken(String refreshTokenValue) {
    configurationStorage.write(customerRefreshToken, refreshTokenValue);
  }

  String getRefreshToken() {
    return configurationStorage.read(customerRefreshToken) ?? "0";
  }
  ...
  GetDrawerCategoriesData? getDrawerCategories() {
    ...
    GetDrawerCategoriesData? drawerData = GetDrawerCategoriesData.fromJson(
      data ?? {},
    );
    return drawerData;
  }

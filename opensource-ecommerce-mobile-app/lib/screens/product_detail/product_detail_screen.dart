...
class _ProductDetailScreenState extends State<ProductDetailScreen>
  ...
  final List<Map<String, dynamic>> _reviews = [
    ...
    },
    {
      ...
      'date': '1 week ago',
      'comment':
          'Great product! Really comfortable and looks exactly like the pictures.',
    },
    {
      'name': 'Emily Davis',
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    color: BazarTheme.lightGreen.withOpacity(
                                      0.3,
                                    ),
  ...
  Widget _buildAppBarButton(IconData icon, VoidCallback onTap, {Color? color}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, color: color ?? BazarTheme.textPrimary, size: 22),
      ),
    );
  }

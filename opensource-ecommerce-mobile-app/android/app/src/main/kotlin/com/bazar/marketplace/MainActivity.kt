...
import com.bazar.marketplace.arcore.activities.ArActivity
import com.bazar.marketplace.mlkit.activities.CameraSearchActivity
import okhttp3.*
...
class MainActivity : FlutterFragmentActivity() {
    ...
    private val returnUrl = "com.bazar.marketplace://paypalpay"
    var accessToken = ""
    ...
    private val EVENTS = "com.bazar.marketplace/channel"
                ...
                methodChannelResult = result;
                 if (call.method.equals("fileviewer")) {
                    ...
                    val photoURI: Uri = FileProvider.getUriForFile(
                        ...
                        "com.bazar.marketplace.provider",
                        file
                    )
    ...
    companion object {
        const val TAG = "BazarMainActivity"
    }

 ...
 *
 */
import 'package:bazar_marketplace_app/utils/extension.dart';
          ...
          return CheckboxListTile(
            ...
            onChanged: (value) {
              ...
              _setSelectedValue(option.id!, {
                ...
                'values': set
                    .map(
                      (id) => option.customizableOptionPrices
      ...
      children: [
        ...
        ...?option.customizableOptionPrices?.map<Widget>((priceOption) {
          return RadioListTile<int>(
            ...
            selectedTileColor: theme.colorScheme.onSurface.withOpacity(
              0.1,
            ), // subtle highlight
            onChanged: (value) {
              _setSelectedValue(option.id!, {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: DropdownButton<int>(
            isExpanded: true,
            value: selected,
            items: option.customizableOptionPrices?.map<DropdownMenuItem<int>>((
              priceOption,
            ) {
          ...
          children:
              option.customizableOptionPrices?.map<Widget>((priceOption) {
                ...
                return ChoiceChip(
                  ...
                  elevation: 0,
                  side: isSelected
                      ? BorderSide(width: 1, color: BazarTheme.linkColor)
                      : BorderSide.none,
                  selectedShadowColor: BazarTheme.linkColor,
                  selectedColor: BazarTheme.linkColor.withAlpha(200),
                  onSelected: (value) {
                    final set = Set<int>.from(selected);
                    if (value) {
                      set.add(priceOption.id!);
          ...
          onTap: () async {
            DateTime? selectedDate = await showDatePicker(
              ...
              builder: (BuildContext context, Widget? child) {
                return Theme(
                  data: ThemeData(
                    primarySwatch: BazarTheme.greyMaterialColor,
                    colorScheme: const ColorScheme.light(
                      primary: BazarTheme.accentColor,
                    ),
                    datePickerTheme: Theme.of(context).datePickerTheme, dialogTheme: DialogThemeData(backgroundColor: BazarTheme.primaryColor),
                  ),
                  ...
                  return Theme(
                    data: ThemeData(
                      ...
                      timePickerTheme: Theme.of(context).timePickerTheme
                          .copyWith(
                            backgroundColor: BazarTheme.primaryColor,
                            dialBackgroundColor: BazarTheme.primaryColor,
                            dayPeriodTextColor:
                                BazarTheme.darkTheme.dividerTheme.color,
                          ), dialogTheme: DialogThemeData(backgroundColor: BazarTheme.primaryColor),
                    ),
                    child: child ?? const Text(""),
                  );
                },

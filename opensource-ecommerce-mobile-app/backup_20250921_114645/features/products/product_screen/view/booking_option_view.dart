...
import 'package:bazar_marketplace_app/screens/location/view/location_screen.dart';
import 'package:bazar_marketplace_app/screens/product_screen/utils/index.dart';
import 'package:bazar_marketplace_app/screens/product_screen/view/widget/booking_product_availbility.dart';
import 'package:bazar_marketplace_app/screens/product_screen/view/widget/event_booking.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                        ...
                        if (bookingOptions?.appointmentSlot?.sameSlotAllDays ==
                          ...
                          Theme(
                            data: Theme.of(context).copyWith(
                                dividerColor: BazarTheme.transparentColor),
                            child: ExpansionTile(
                ...
                Row(
                  children: [
                    Radio<String>(
                      ...
                      fillColor:
                          WidgetStateProperty.all(BazarTheme.accentColor),
                    ),
                    Text(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                            color: BazarTheme.skeletonLoaderColorDark),
          ...
          //             vertical: 12, horizontal: 16),
          //         decoration: BoxDecoration(
          //           border: Border.all(color: BazarTheme.skeletonLoaderColorDark),
          //           borderRadius: BorderRadius.circular(8),
          //         ),
          //         child: Text(
          //           selectedBooking["date"] != null
                      ...
                      decoration: InputDecoration(
                        ...
                        errorBorder: OutlineInputBorder(
                            borderRadius: const BorderRadius.all(
                                Radius.circular(AppSizes.spacingSmall)),
                            borderSide:
                                BorderSide(color: BazarTheme.errorColor)),

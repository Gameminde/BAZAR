...
const String baseDomain = "https://jsonplaceholder.typicode.com";

///base url for the application - API de démonstration
...
const String defaultAppTitle = "BAZAR Marketplace";
